...
import {
  ...
  DropdownToggle,
  DropdownMenu,
  DropdownItem, InputGroup, InputGroupAddon, InputGroupText, Input
} from 'reactstrap';
        ...
        <Navbar color="dark" dark expand="md">
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              ...
              <NavItem>
                {(!isLogin) ? (<Link className="nav-link" to={"/login?ref=" + this.props.location.pathname}>Login</Link>) : (<Link className="nav-link" to="/profile">{isLogin}</Link>)}
              </NavItem>
              {(isLogin) ?
